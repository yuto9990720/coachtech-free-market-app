...
<div class="purchase-page">
    ...
    <div class="purchase-left">
        ...
        <form id="purchase-form" action="<?php echo e(route('purchase.store', $item)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <span class="form-error" style="display:block; margin-top:8px;"><?php echo e($message); ?></span>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            ...
            <div class="purchase-section">
                ...
                <div class="address-display">
                    ...
                    <p><?php echo e($address['address'] ?? ''); ?><?php echo e(!empty($address['building']) ? ' ' . $address['building'] : ''); ?></p>
                </div>
            </div>
